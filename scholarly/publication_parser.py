...
class _SearchScholarIterator(object):
    ...
    def _load_url(self, url: str):
        ...
        self._pos = 0
        self._rows = self._soup.find_all('div', class_='gs_r gs_or gs_scl') + self._soup.find_all('div', class_='gsc_mpat_ttl') + self._soup.find_all('div', class_='gs_r gs_or gs_scl gs_fmar')
...
class PublicationParser(object):
    ...
    def _scholar_pub(self, __data, publication: Publication):
        ...
        publication["bib"]["abstract"] = publication["bib"].get("abstract", "")
